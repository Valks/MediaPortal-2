...
namespace MediaPortal.Backend.Services.ClientCommunication.MPnP
{
  ...
  /// </summary>
  public class MPnPClientControllerServiceProxy : UPnPServiceProxyBase, IClientController
  {
    public MPnPClientControllerServiceProxy(CpService serviceStub) : base(serviceStub, "ClientController") { }
