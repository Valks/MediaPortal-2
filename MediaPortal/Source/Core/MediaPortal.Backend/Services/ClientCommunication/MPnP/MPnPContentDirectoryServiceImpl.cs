...
{
  /// <summary>
  /// Provides the UPnP extended service for the MediaPortal 2 content directory.
  /// </summary>
  /// <remarks>
  /// This service extends the ContentDirectory service of the UPnP standard MediaServer device with MediaPortal 2 specific
  /// functions. It uses a bit different data structure for media items. It also provides special actions to manage shares
  /// and media item aspect metadata schemas.
  /// </remarks>
  public class MPnPContentDirectoryServiceImpl : DvService
  {
    ...
    public MPnPContentDirectoryServiceImpl()
      : base(
        ...
        CallContext context)
    {
      ...
      ICollection<MediaItem> result = ServiceRegistration.Get<IMediaLibrary>().Browse(parentDirectoryId, necessaryMIATypes, optionalMIATypes, null, null);
       outParams = new List<object> { result };
      return null;
    }
