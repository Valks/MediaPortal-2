...
namespace MediaPortal.Backend.Services.UserProfileDataManagement
{
  ...
  /// </summary>
  public class MPnPUserProfileDataManagementServiceImpl : DvService
  {
    public MPnPUserProfileDataManagementServiceImpl() : base(
        MPnPTypesAndIds.USER_PROFILE_DATA_MANAGEMENT_SERVICE_TYPE, MPnPTypesAndIds.USER_PROFILE_DATA_MANAGEMENT_SERVICE_TYPE_VERSION,
        MPnPTypesAndIds.USER_PROFILE_DATA_MANAGEMENT_SERVICE_ID)
    {
      // Used to transport an enumeration of user profiles
      DvStateVariable A_ARG_TYPE_UserProfileEnumeration = new DvStateVariable("A_ARG_TYPE_UserProfileEnumeration", new DvExtendedDataType(MPnPExtendedDataTypes.DtUserProfileEnumeration))
          {
            SendEvents = false,
          };
      AddStateVariable(A_ARG_TYPE_UserProfileEnumeration);

      DvStateVariable A_ARG_TYPE_UserProfile = new DvStateVariable("A_ARG_TYPE_UserProfile", new DvExtendedDataType(MPnPExtendedDataTypes.DtUserProfile))
          {
            SendEvents = false,
          };
