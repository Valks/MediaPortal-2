...
namespace MediaPortal.Common.Services.ResourceAccess
{
  ...
  /// </summary>
  public class MPnPResourceInformationServiceProxy : UPnPServiceProxyBase, IResourceInformationService
  {
    public MPnPResourceInformationServiceProxy(CpService serviceStub) : base(serviceStub, "ResourceInformation") { }
