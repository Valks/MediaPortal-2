...
namespace MediaPortal.Common.Services.ResourceAccess
{
  ...
  /// </summary>
  public class MPnPResourceInformationServiceImpl : DvService
  {
    public MPnPResourceInformationServiceImpl() : base(
        MPnPTypesAndIds.RESOURCE_INFORMATION_SERVICE_TYPE, MPnPTypesAndIds.RESOURCE_INFORMATION_SERVICE_TYPE_VERSION,
        MPnPTypesAndIds.RESOURCE_INFORMATION_SERVICE_ID)
    {
