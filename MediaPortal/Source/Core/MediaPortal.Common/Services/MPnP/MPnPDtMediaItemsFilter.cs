...
namespace MediaPortal.Common.Services.MPnP
{
  ...
  /// </summary>
  public class MPnPDtMediaItemsFilter : UPnPExtendedDataType
  {
    public const string DATATYPE_NAME = "DtMediaItemsFilter";

    internal MPnPDtMediaItemsFilter() : base(DataTypesConfiguration.DATATYPES_SCHEMA_URI, DATATYPE_NAME)
    {
    }
