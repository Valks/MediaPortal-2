...
namespace MediaPortal.Common.Services.MPnP
{
  ...
  /// </summary>
  public class MPnPDtUserProfileEnumeration : UPnPExtendedDataType
  {
    public const string DATATYPE_NAME = "DtUserProfileEnumeration";

    internal MPnPDtUserProfileEnumeration() : base(DataTypesConfiguration.DATATYPES_SCHEMA_URI, DATATYPE_NAME)
    {
    }
