...
namespace MediaPortal.Common.Services.MPnP
{
  ...
  /// </summary>
  public class MPnPDtMLQueryResultGroupEnumeration : UPnPExtendedDataType
  {
    public const string DATATYPE_NAME = "DtMLQueryResultGroupEnumeration";

    internal MPnPDtMLQueryResultGroupEnumeration() : base(DataTypesConfiguration.DATATYPES_SCHEMA_URI, DATATYPE_NAME)
    {
    }
