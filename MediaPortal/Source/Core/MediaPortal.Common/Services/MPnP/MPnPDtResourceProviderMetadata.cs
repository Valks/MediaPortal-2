...
namespace MediaPortal.Common.Services.MPnP
{
  ...
  /// </summary>
  public class MPnPDtResourceProviderMetadata : UPnPExtendedDataType
  {
    public const string DATATYPE_NAME = "DtResourceProviderMetadata";

    internal MPnPDtResourceProviderMetadata() : base(DataTypesConfiguration.DATATYPES_SCHEMA_URI, DATATYPE_NAME)
    {
    }
