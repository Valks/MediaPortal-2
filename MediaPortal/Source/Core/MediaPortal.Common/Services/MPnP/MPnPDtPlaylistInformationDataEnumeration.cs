...
{
  /// <summary>
  /// Data type serializing and deserializing enumerations of <see cref="PlaylistInformationData"/> objects.
  /// </summary>
  public class MPnPDtPlaylistInformationDataEnumeration : UPnPExtendedDataType
  {
    public const string DATATYPE_NAME = "DtPlaylistInformationDataEnumeration";

    internal MPnPDtPlaylistInformationDataEnumeration() : base(DataTypesConfiguration.DATATYPES_SCHEMA_URI, DATATYPE_NAME)
    {
    }
