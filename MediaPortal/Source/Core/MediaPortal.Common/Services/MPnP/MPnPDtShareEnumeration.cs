...
namespace MediaPortal.Common.Services.MPnP
{
  ...
  /// </summary>
  public class MPnPDtShareEnumeration : UPnPExtendedDataType
  {
    public const string DATATYPE_NAME = "DtShareEnumeration";

    internal MPnPDtShareEnumeration() : base(DataTypesConfiguration.DATATYPES_SCHEMA_URI, DATATYPE_NAME)
    {
    }
