...
namespace MediaPortal.Common.Services.MPnP
{
  ...
  /// </summary>
  public class MPnPDtMediaItemAspectEnumeration : UPnPExtendedDataType
  {
    public const string DATATYPE_NAME = "DtMediaItemAspectEnumeration";

    internal MPnPDtMediaItemAspectEnumeration() : base(DataTypesConfiguration.DATATYPES_SCHEMA_URI, DATATYPE_NAME)
    {
    }
