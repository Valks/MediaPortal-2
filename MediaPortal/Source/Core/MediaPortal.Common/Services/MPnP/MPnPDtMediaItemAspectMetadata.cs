...
namespace MediaPortal.Common.Services.MPnP
{
  ...
  /// </summary>
  public class MPnPDtMediaItemAspectMetadata : UPnPExtendedDataType
  {
    public const string DATATYPE_NAME = "DtMediaItemAspectMetadata";

    internal MPnPDtMediaItemAspectMetadata() : base(DataTypesConfiguration.DATATYPES_SCHEMA_URI, DATATYPE_NAME)
    {
    }
