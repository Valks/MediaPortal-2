...
namespace MediaPortal.Common.Services.MPnP
{
  ...
  /// </summary>
  public class MPnPDtMediaItemEnumeration : UPnPExtendedDataType
  {
    public const string DATATYPE_NAME = "DtMediaItemEnumeration";

    internal MPnPDtMediaItemEnumeration() : base(DataTypesConfiguration.DATATYPES_SCHEMA_URI, DATATYPE_NAME)
    {
    }
