...
{
  /// <summary>
  /// Data type serializing and deserializing enumerations of <see cref="PlaylistContents"/> objects.
  /// </summary>
  public class MPnPDtPlaylistContents : UPnPExtendedDataType
  {
    public const string DATATYPE_NAME = "DtPlaylistContents";

    internal MPnPDtPlaylistContents() : base(DataTypesConfiguration.DATATYPES_SCHEMA_URI, DATATYPE_NAME)
    {
    }
