...
namespace MediaPortal.Common.Services.MPnP
{
  ...
  /// </summary>
  public class MPnPDtMediaCategoryEnumeration : UPnPExtendedDataType
  {
    public const string DATATYPE_NAME = "DtMediaCategoryEnumeration";

    internal MPnPDtMediaCategoryEnumeration() : base(DataTypesConfiguration.DATATYPES_SCHEMA_URI, DATATYPE_NAME)
    {
    }
