...
namespace MediaPortal.Common.Services.MPnP
{
  ...
  /// </summary>
  public class MPnPDtResourcePathMetadataEnumeration : UPnPExtendedDataType
  {
    public const string DATATYPE_NAME = "DtResourcePathMetadataEnumeration";

    internal MPnPDtResourcePathMetadataEnumeration() : base(DataTypesConfiguration.DATATYPES_SCHEMA_URI, DATATYPE_NAME)
    {
    }
