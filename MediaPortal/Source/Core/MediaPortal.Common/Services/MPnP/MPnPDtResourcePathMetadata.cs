...
namespace MediaPortal.Common.Services.MPnP
{
  ...
  /// </summary>
  public class MPnPDtResourcePathMetadata : UPnPExtendedDataType
  {
    public const string DATATYPE_NAME = "DtResourcePathMetadata";

    internal MPnPDtResourcePathMetadata() : base(DataTypesConfiguration.DATATYPES_SCHEMA_URI, DATATYPE_NAME)
    {
    }
