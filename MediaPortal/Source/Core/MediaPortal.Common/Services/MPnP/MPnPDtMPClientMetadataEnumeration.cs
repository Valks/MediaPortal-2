...
namespace MediaPortal.Common.Services.MPnP
{
  ...
  /// </summary>
  public class MPnPDtMPClientMetadataEnumeration : UPnPExtendedDataType
  {
    public const string DATATYPE_NAME = "DtClientMetadataEnumeration";

    internal MPnPDtMPClientMetadataEnumeration() : base(DataTypesConfiguration.DATATYPES_SCHEMA_URI, DATATYPE_NAME)
    {
    }
