...
namespace MediaPortal.Common.Services.MPnP
{
  ...
  /// </remarks>
  public class MPnPDtMediaItemAttributeValues : UPnPExtendedDataType
  {
    public const string DATATYPE_NAME = "DtMediaItemAttributeValues";

    internal MPnPDtMediaItemAttributeValues() : base(DataTypesConfiguration.DATATYPES_SCHEMA_URI, DATATYPE_NAME)
    {
    }
