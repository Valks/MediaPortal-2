...
namespace MediaPortal.Common.Services.MPnP
{
  ...
  /// </summary>
  public class MPnPDtResourceProviderMetadataEnumeration : UPnPExtendedDataType
  {
    public const string DATATYPE_NAME = "DtResourceProviderMetadataEnumeration";

    internal MPnPDtResourceProviderMetadataEnumeration() : base(DataTypesConfiguration.DATATYPES_SCHEMA_URI, DATATYPE_NAME)
    {
    }
