...
{
  /// <summary>
  /// Provides the MediaPortal 2 MPnP client's proxy for the user profile data management service.
  /// </summary>
  public class MPnPUserProfileDataManagementServiceProxy : UPnPServiceProxyBase, IUserProfileDataManagement
  {
    public MPnPUserProfileDataManagementServiceProxy(CpService serviceStub) : base(serviceStub, "UserProfileDataManagement") { }
