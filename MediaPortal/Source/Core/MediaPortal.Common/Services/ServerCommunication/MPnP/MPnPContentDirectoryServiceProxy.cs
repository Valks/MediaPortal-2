...
{
  /// <summary>
  /// Encapsulates the MediaPortal 2 MPnP client's proxy for the ContentDirectory service.
  /// </summary>
  public class MPnPContentDirectoryServiceProxy : UPnPServiceProxyBase, IContentDirectory
  {
    ...
    public MPnPContentDirectoryServiceProxy(CpService serviceStub) : base(serviceStub, "ContentDirectory")
    {
