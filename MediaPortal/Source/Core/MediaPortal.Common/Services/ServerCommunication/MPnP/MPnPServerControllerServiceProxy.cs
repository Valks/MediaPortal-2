...
namespace MediaPortal.Common.Services.ServerCommunication.MPnP
{
  ...
  /// </summary>
  public class MPnPServerControllerServiceProxy : UPnPServiceProxyBase, IServerController
  {
    ...
    public MPnPServerControllerServiceProxy(CpService serviceStub) : base(serviceStub, "ServerController")
    {
